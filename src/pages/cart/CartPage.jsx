...
import { setUser } from "../../entities/cart/model/cartSlice";

const Nav = lazy(() => import("../../widgets/layout/Nav"));
const CartItems = lazy(() => import("../../entities/cart/ui/CartItems"));
const CartSummary = lazy(() => import("../../entities/cart/ui/CartSummary"));
