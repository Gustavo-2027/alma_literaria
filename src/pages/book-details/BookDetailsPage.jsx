...
const RelatedBooks = lazy(() => import("../../widgets/books/ui/RelatedBooks"));
const Reviews = lazy(() => import("../../entities/book/ui/Reviews"));
...
export default function BookDetailsPage() {
  ...
  if (!book) {
    return (
      <div
        className={`flex min-h-screen items-center justify-center px-4 py-16 ${pageClass}`}
      >
        ...
        <section className="mb-20 grid grid-cols-1 gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-20">
          <div className="flex items-start justify-center">
            <div className="w-full max-w-[540px]">
              <div
                className={`flex aspect-[4/5] items-center justify-center ${imageWrapperClass}`}
              >
                <img
                  src={book.image}
                  alt={book.name}
