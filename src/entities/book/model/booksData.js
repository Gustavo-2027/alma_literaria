...
const rawBooks = [
  ...
  // Novos clássicos adicionados
  {
    ...
    name: "Dom Casmurro",
    price: 32.9,
    image: "https://m.media-amazon.com/images/I/71g9L8i8uGL.jpg",
    author: "Machado de Assis",
    description:
      "Um dos maiores romances brasileiros, centrado em memória, ciúme, ambiguidade e ironia narrativa.",
    genre: "Romance Psicológico",
    publisher: "Penguin Companhia",
  ...
  },
  {
    ...
    price: 34.9,
    image: "https://m.media-amazon.com/images/I/81dJdN9Ck4L.jpg",
    author: "Machado de Assis",
    description:
      "Romance revolucionário da literatura brasileira, irônico, sofisticado e formalmente inovador.",
    genre: "Romance Clássico",
    publisher: "Penguin Companhia",
  ...
  },
  {
    ...
    name: "Senhora",
    price: 27.9,
    image: "https://m.media-amazon.com/images/I/71n8e8Y42tL.jpg",
    author: "José de Alencar",
    description:
      "Clássico do romantismo brasileiro sobre amor, interesse, orgulho e posição social.",
  ...
  },
  {
    ...
    name: "O Cortiço",
    price: 29.9,
    image: "https://m.media-amazon.com/images/I/81qWwQyGxJL.jpg",
    author: "Aluísio Azevedo",
    description:
      "Marco do naturalismo brasileiro, retratando desejo, desigualdade, ambiente e determinismo social.",
  ...
  },
  {
    ...
    price: 28.9,
    image: "https://m.media-amazon.com/images/I/71F9jP1PVBL.jpg",
    author: "Lima Barreto",
    description:
      "Romance brasileiro crítico e atualíssimo sobre nacionalismo, idealismo e frustração política.",
    genre: "Romance Social",
    publisher: "Penguin Companhia",
    publication_year: 1915,
    isbn: "9788563560124",
  ...
  },
  {
    ...
    name: "Moby Dick",
    price: 54.9,
    image: "https://m.media-amazon.com/images/I/81PRVY7aJ-L.jpg",
    author: "Herman Melville",
    description:
      "Grande romance marítimo sobre obsessão, destino, natureza e os limites da vontade humana.",
    genre: "Romance de Aventura",
    publisher: "Penguin Companhia",
  ...
  },
  {
    ...
    price: 64.9,
    image: "https://m.media-amazon.com/images/I/81aCBMZx8ML.jpg",
    author: "Thomas Mann",
    description:
      "Romance europeu monumental sobre tempo, doença, civilização e crise espiritual.",
    genre: "Romance Filosófico",
    publisher: "Companhia das Letras",
  ...
  },
  {
    ...
    name: "Fausto",
    price: 44.9,
    image: "https://m.media-amazon.com/images/I/81W9r+g6DML.jpg",
    author: "Goethe",
    description:
      "Clássico absoluto sobre ambição, conhecimento, desejo e os pactos do espírito humano.",
  ...
  },
  {
    ...
    price: 24.9,
    image: "https://m.media-amazon.com/images/I/71B0gM6c6yL.jpg",
    author: "León Tolstói",
    description:
      "Novela clássica sobre finitude, autenticidade, sofrimento e o sentido da vida.",
  ...
  },
  {
    ...
    price: 22.9,
    image: "https://m.media-amazon.com/images/I/71mZsUq6S5L.jpg",
    author: "Anton Tchekhov",
    description:
      "Narrativa curta e refinada sobre amor, rotina, desejo e revelação íntima.",
  ...
  },
  {
    ...
    name: "Almas Mortas",
    price: 39.9,
    image: "https://m.media-amazon.com/images/I/81zYxw8b1FL.jpg",
    author: "Nikolai Gógol",
    description:
      "Sátira poderosa da sociedade russa, misturando humor, crítica moral e absurdo.",
  ...
  },
  {
    ...
    price: 39.9,
    image: "https://m.media-amazon.com/images/I/81WQjR4+muL.jpg",
    author: "Thomas Hardy",
    description:
      "Romance clássico sobre destino, injustiça, inocência e rigidez moral.",
  ...
  },
  {
    ...
    price: 29.9,
    image: "https://m.media-amazon.com/images/I/81E6zT9gzqL.jpg",
    author: "Robert Louis Stevenson",
    description:
      "Aventura clássica com ritmo, imaginação e um dos universos piratas mais marcantes da literatura.",
    genre: "Romance de Aventura",
    publisher: "Zahar",
  ...
  },
  {
    ...
    price: 42.9,
    image: "https://m.media-amazon.com/images/I/71xBf8m3HkL.jpg",
    author: "José Saramago",
    description:
      "Romance contemporâneo já consagrado como clássico, sobre civilização, barbárie e fragilidade humana.",
    ...
    collection: "classicos-lusofonos",
  },
];
...
function sortAlphabetically(list) {
  return [...safeArray(list)].sort((a, b) => String(a).localeCompare(String(b), "pt-BR"));
}
...
function pluckUniqueSorted(list, key) {
  return sortAlphabetically(uniqueValues(safeArray(list).map((item) => item?.[key]).filter(Boolean)));
}
