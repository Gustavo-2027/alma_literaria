...
export default function Footer() {
  ...
  return (
    <footer className={`mt-24 border-t px-4 py-14 sm:px-8 lg:px-12 ${theme.wrapper}`}>
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 gap-14 md:grid-cols-[1.2fr_0.8fr_0.8fr] md:gap-12">
          <div>
            <p className={`text-[11px] uppercase tracking-[0.32em] ${theme.eyebrow}`}>
              Alma Literária
            </p>
          ...
          <div>
            <p className={`mb-5 text-[11px] uppercase tracking-[0.24em] ${theme.eyebrow}`}>
              Navegação
            </p>
